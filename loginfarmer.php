      ...
      <div class="box">
        <div class="inner-box">
          <div class="forms-wrap">
            <form action="loginfarmer.php" method="post" autocomplete="off" class="sign-in-form">
              <div class="logo">
            ...
            <form action="loginfarmer.php" method="post" autocomplete="off" class="sign-up-form">
              <div class="logo">
                <img src="assets/css/img/logo.png" alt="easyclass" />
                <h4>Aggregte Agro</h4>
              </div>
