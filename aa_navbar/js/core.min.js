!(function (s) {
    ...
    function f(t, e) {
      t.parents(".banner-headline").hasClass("type")
        ...
        : t.parents(".banner-headline").hasClass("clip") &&
          t
            .parents(".banner-words-wrapper")
            .animate({ width: t.width() + 10 }, p, function () {
              setTimeout(function () {
                u(t);
              }, s);
            });
      ...
      t.addClass("in").removeClass("out"),
        t.is(":last-child")
          ? (e.parents(".banner-headline").hasClass("type") &&
              setTimeout(function () {
                e.parents(".banner-words-wrapper").addClass("waiting");
              }, 200),
            i ||
              setTimeout(function () {
                u(e);
      ...
      (function (t) {
        ...
        t.each(function () {
          ...
          s.hasClass("loading-bar")
            ? ((o = n),
              setTimeout(function () {
                s.find(".banner-words-wrapper").addClass("is-loading");
              }, l))
            : s.hasClass("clip")
            ? ((e = (t = s.find(".banner-words-wrapper")).width() + 10),
              t.css("width", e))
            : s.hasClass("type") ||
        ...
        f(this).on("bind", "tabactivate", function (t, e) {
          ...
          this.each(function () {
            ...
            s
              ...
              1 == c && s.css({ width: "100%", margin: "0px" }),
              "accordion" == h &&
            ...
            var r,
              a = 0;
            "" == p ||
              (null !== (r = p.match(new RegExp(o + "([0-9]+)"))) &&
                2 === r.length &&
        ...
        if (o.loop) n = this._clones.length / 2 + this._items.length - 1;
          ...
          if ((e = this._items.length))
            for (
              ...
              e-- &&
              !(s < (i += this._items[e].width() + this.settings.margin));
              ...
              u.options.showElement(l),
                ...
                l.parents().each(function () {
                  ...
                  if (!0 === t.data("stellar-offset-parent"))
                    return (h = d), (c = p), (n = t), !1;
                  (d += t.position().left), (p += t.position().top);
                }),
                (s =
            ...
            t.each(function () {
              ...
              n.data("stellar-backgroundStartingLeft")
                ...
                n.parents().each(function () {
                  var t = f(this);
                  if (!0 === t.data("stellar-offset-parent"))
                    return (a = h), (l = c), (o = t), !1;
                  (h += t.position().left), (c += t.position().top);
                }),
                (t =
    ...
    (i.prototype.add = function (t) {
      ...
      (i.prototype.createThrottledResizeHandler = function () {
        ...
        this.adapter.on("resize.waypoints", function () {
          e.didResize || ((e.didResize = !0), u.requestAnimationFrame(t));
        });
      }),
          ...
          for (n in this.waypoints[e]) {
            ...
            l.element !== l.element.window &&
              ...
              !p && a && h
                ...
                : ((!p && c) || (p && r.oldScroll >= l.triggerPoint)) &&
  ...
  (function (t) {
    ...
    (t.prototype = {
      ...
      _close: function () {
        ...
        f.bgOverlay.detach(),
          ...
          f.st.autoFocusLast && f._lastFocusedEl && h(f._lastFocusedEl).focus(),
          (f.currItem = null),
          (f.content = null),
          (f.currTemplate = null),
          (f.prevHeight = 0),
      ...
      appendContent: function (t, e) {
        (f.content = t)
          ? f.st.showCloseBtn && f.st.closeBtnInside && !0 === f.currTemplate[e]
            ? f.content.find(".mfp-close").length || f.content.append(u())
            : (f.content = t)
          : (f.content = ""),
          p("BeforeAppend"),
      ...
      _openClick: function (t, e, i) {
        if (
          (void 0 !== i.midClick ? i : h.magnificPopup.defaults).midClick ||
          !(2 === t.which || t.ctrlKey || t.metaKey || t.altKey || t.shiftKey)
        ) {
          var s = (void 0 !== i.disableOn ? i : h.magnificPopup.defaults)
            .disableOn;
          if (s)
            if (h.isFunction(s)) {
    ...
    function k() {
      T && ($.after(T.addClass(C)).detach(), (T = null));
    }
    var C,
      $,
      T,
          ...
          if ((k(), t.src)) {
            ...
            return (
              o.length
                ? ((i = o[0].parentNode) &&
                    i.tagName &&
                    ($ || ((C = s.hiddenClass), ($ = d(C)), (C = "mfp-" + C)),
                    (T = o.after($).detach().removeClass(C))),
                  f.updateStatus("ready"))
                : (f.updateStatus("error", s.tNotFound), (o = h("<div>"))),
              (t.inlineElement = o)
            );
          }
    ...
    function P() {
      F && h(document.body).removeClass(F);
    }
    function E() {
      P(), f.req && f.req.abort();
    }
    ...
    h.magnificPopup.registerModule(z, {
      ...
      proto: {
        ...
        getAjax: function (s) {
          F && h(document.body).addClass(F), f.updateStatus("loading");
          var t = h.extend(
            {
              url: s.src,
  ...
  (function (o) {
    o.fn.niceSelect = function (t) {
      ...
      function s(t) {
        ...
        s.find(".current").html(t.data("display") || t.text()),
          e.each(function (t) {
            var e = o(this),
              i = e.data("display");
            s.find("ul").append(
      ...
      this.hide(),
        ...
        o(document).on("keydown.nice_select", ".nice-select", function (t) {
          var e,
            i = o(this),
            s = o(i.find(".focus") || i.find(".list .option.selected"));
          if (32 == t.keyCode || 13 == t.keyCode)
            return (i.hasClass("open") ? s : i).trigger("click"), !1;
          if (40 == t.keyCode)
            return (
              i.hasClass("open")
                ? 0 <
                    (e = s.nextAll(".option:not(.disabled)").first()).length &&
                  (i.find(".focus").removeClass("focus"), e.addClass("focus"))
                : i.trigger("click"),
              !1
            );
          if (38 == t.keyCode)
            return (
              i.hasClass("open")
                ? 0 <
                    (s = s.prevAll(".option:not(.disabled)").first()).length &&
      ...
      appendGrid: function () {
        if (this.options.grid) {
          ...
          for (
            ...
            for (
              s = c,
                100 < (h = this.toFixed(i * t)) && (h = 100),
                o = ((this.coords.big[t] = h) - i * (t - 1)) / (s + 1),
                e = 1;
              e <= s && 0 !== h;
              e++
            )
    ...
    var h = /\blang(?:uage)?-([\w-]+)\b/i,
      ...
      E = {
        ...
        util: {
          encode: function (t) {
            return t instanceof F
              ? new F(t.type, E.util.encode(t.content), t.alias)
              : Array.isArray(t)
              ? t.map(E.util.encode)
              : t
                  .replace(/&/g, "&amp;")
        ...
        highlightElement: function (t, e, i) {
          for (var s, o = "none", n = t; n && !h.test(n.className); )
            n = n.parentNode;
          n &&
            ((o = (n.className.match(h) || [, "none"])[1].toLowerCase()),
            (s = E.languages[o])),
            (t.className =
              t.className.replace(h, "").replace(/\s+/g, " ") +
              " language-" +
              o),
            t.parentNode &&
              ((n = t.parentNode),
              /pre/i.test(n.nodeName) &&
                (n.className =
                  n.className.replace(h, "").replace(/\s+/g, " ") +
                  " language-" +
                  o));
          function r(t) {
            (a.highlightedCode = t),
        ...
        highlight: function (t, e, i) {
          ...
          return (
            ...
            F.stringify(E.util.encode(i.tokens), i.language)
          );
        },
        matchGrammar: function (t, e, i, s, o, n, r) {
          for (var a in i)
            if (i.hasOwnProperty(a) && i[a]) {
              if (a == r) return;
              for (
                var l = i[a], l = "Array" === E.util.type(l) ? l : [l], h = 0;
                h < l.length;
                ++h
              ) {
                var c,
                ...
                f &&
                  !d.pattern.global &&
                  ((c = d.pattern.toString().match(/[imuy]*$/)[0]),
                  (d.pattern = RegExp(d.pattern.source, c + "g"))),
                  (d = d.pattern || d);
                for (var _ = s, v = o; _ < e.length; v += e[_].length, ++_) {
                  var y = e[_];
                  if (e.length > t.length) return;
                  if (!(y instanceof F)) {
                    if (f && _ != e.length - 1) {
                      if (((d.lastIndex = v), !($ = d.exec(t)))) break;
                      for (
                        var b = $.index + (u ? $[1].length : 0),
                          w = $.index + $[0].length,
                          x = _,
                          k = v,
                          C = e.length;
                        x < C && (k < w || (!e[x].type && !e[x - 1].greedy));
                        ++x
                      )
                        (k += e[x].length) <= b && (++_, (v = k));
                      if (e[_] instanceof F) continue;
                      (T = x - _), (y = t.slice(v, k)), ($.index -= v);
                    } else {
                      d.lastIndex = 0;
                      var $ = d.exec(y),
                        T = 1;
                    ...
                    if ($) {
                      u && (m = $[1] ? $[1].length : 0),
                        (w = (b = $.index + m) + ($ = $[0].slice(m)).length);
                      var S = y.slice(0, b),
                        P = y.slice(w),
                        y = [_, T];
                      S && (++_, (v += S.length), y.push(S));
                      S = new F(a, p ? E.tokenize($, p) : $, g, $, f);
                      if (
                        (y.push(S),
                        P && y.push(P),
                        Array.prototype.splice.apply(e, y),
                        1 != T && E.matchGrammar(t, e, i, _, v, !0, a),
                        n)
                      )
                        break;
                    } else if (n) break;
    ...
    if (
      ...
      (F.stringify = function (t, e) {
        ...
        if (Array.isArray(t))
          return t
            .map(function (t) {
              return F.stringify(t, e);
            })
            .join("");
        var i = {
          type: t.type,
          content: F.stringify(t.content, e),
          tag: "span",
