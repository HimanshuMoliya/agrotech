...
<?php
        ...
        if(isset($_POST['first_name'])){
            ...
            if($password == $confirm_password){
                ...
                $insert = "INSERT INTO `register` ( `uid`, `first_name`, `last_name`, `email`, `phoneno`, `password`, `date`) VALUES ( $user_id, '$first_name', '$last_name', '$mail', '$phoneno', '$password', current_timestamp())";
